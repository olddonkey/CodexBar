...
- Grok: show a 0% usage bar for a billing period that has not recorded usage yet instead of reporting usage as unavailable, while still refusing any other percentage the billing surfaces did not publish.
